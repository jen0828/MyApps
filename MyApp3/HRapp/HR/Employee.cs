...
namespace HRapp.HR
{
  public class Employee : IEmployee
  {
    ...
    public Employee(string firstName, string lastName, string email, DateTime birthDay, double? hourlyRate, string street, string houseNumber, string postCode, string city)
    {
      FirstName = firstName;
      LastName = lastName;
      Email = email;
      ...
      Address = new Address(street, houseNumber, postCode, city);
    }
